<template>
  <UPageGrid
    class="bg-white text-black py-[40px] md:py-[80px] px-8"
    :ui="{
      root: 'grid grid-cols-1 lg:grid-cols-12 gap-0',
    }"
  >
    <!-- LEFT -->
    <UPageGridItem
      :ui="{ root: 'lg:col-span-4 p-4 flex flex-col justify-between' }"
    >
      ...
      <h1 class="underline">LET'S GO</h1>
    </UPageGridItem>

    <!-- MIDDLE -->
    <UPageGridItem
      :ui="{
        root: 'lg:col-span-7 border border-red-500 p-4 flex flex-col justify-between border-l-2 border-gray-200',
      }"
    >
    ...
    <UPageGridItem
      :ui="{
        wrapper: 'bg-[#0b4c53]',
        root: 'lg:col-span-4 p-8 flex flex-col justify-between',
      }"
    >
      <!-- Rating -->
